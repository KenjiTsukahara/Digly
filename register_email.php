  ...
  <body style="background-color:#fff;">
    ...
    <div class="section">
      <div class="email-form">
        ...
        <p>メールアドレスを入力して下さい。入力したメールアドレスへメールが自動送信されます。必ず、受信可能なメールアドレスを使用して登録を行って下さい。</p>
        <div>
          <form method="post" class="form-wrapper-01" action="">
            <input id="" class="inputbox email" type="text" placeholder="<?= h($email); ?>" name="email" />
