...
//get contents 
   $music_post = $dbh->prepare("select id,artistName,trackName,artwork,user_id,f_m from music_contents where user_id=:request ORDER BY created DESC");
...
<html lang="ja">
  ...
  <body>
    ...
    <a href="http://twitter.com/share?url=http://www.digly.jp/user.php?id=<02bd42736c20db9f920fcacf3bab1e74 />&text=ユーザーページ：<34afa264b116f1f5302574a501be3f42 /> by digly.jp [URL]" target="_blank">
      <img src="img/twitter.png" />
    </a>
    <a href="http://www.facebook.com/sharer.php?s=100
	&amp;p[url]=http://www.digly.jp/user.php?id=<b203cdf870342bd01bfe94f2a9ccfffc />&amp;
	p[title]=digly.jp&amp;p[summary]=[userpage]<7b1243a76576a32c0f07281ba42844c7 />&amp;m2w" target="_blank" rel="nofollow">
    ...
    <span>
    <a href="view_post.php?id=<?= $_REQUEST['id']; ?>" style="color:#3498db;">Post</a>
    </span>
    <span>
    ...
    <?php
	    $js_music_post = $dbh->prepare("select preview from music_contents where user_id=:request ORDER BY created DESC");
