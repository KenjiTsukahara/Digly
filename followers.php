<?php 
    ...
    $follow = $dbh->prepare("select * from users where id in (select follow_user_id from follows where follower_user_id=:request ORDER BY created DESC)");
...
<html lang="ja">
  <head>
    ...
    <link href="css/head_add.css" rel="stylesheet" media="screen">
  ...
  <body>
   ...
   <a href="user.php?id=<?= $_SESSION['me']['id']; ?>" class="gactive">
    ...
    <form method="post" action="" class="follow">
      ...
      <?php
			$follow_or = $dbh->prepare("select id from follows where follow_user_id=:me AND follower_user_id=:you");
			$follow_or->execute(array(":me"=>$_SESSION['me']['id'],":you"=>$_REQUEST['id']));
    ...
    <a href="http://twitter.com/share?url=http://www.digly.jp/user.php?id=<4e78a66b446b95a3b164ad8225785baf />&text=ユーザーページ：<4f047ba113b070b04587663ddd62b791 /> by digly.jp [URL]" target="_blank">
      <img src="img/twitter.png" />
    </a>
    <a href="http://www.facebook.com/sharer.php?s=100
		&amp;p[url]=http://www.digly.jp/user.php?id=<67d9e09a812d19003016291f0ac129b3 />&amp;
		p[title]=digly.jp&amp;p[summary]=[userpage]<34a539a804136d0da3ff9ed24bdca251 />&amp;m2w" target="_blank" rel="nofollow">
    ...
    <?php $get_c  = $dbh->prepare("SELECT artwork FROM music_contents WHERE user_id=:g_id ORDER BY rand() LIMIT 3");
