...
//get contents 
   $music_post = $dbh->prepare("select id,artistName,trackName,artwork,user_id,f_m from music_contents where id in (select like_contents_id from music_likes where like_user_id = :request) ORDER BY created DESC");
...
<html lang="ja">
  ...
  <body>
    ...
    <a href="following.php?id=<?= h($_REQUEST['id']); ?>">
      <div class="user-stat-count"><?= h($follow_counts); ?> 
      </div>
    ...
    <a href="http://twitter.com/share?url=http://www.digly.jp/user.php?id=<4ab1186a590d63f73c06be97d8360282 />&text=ユーザーページ：<e248e7a706ac1f50a4f71f92ddfe9677 /> by digly.jp [URL]" target="_blank">
      <img src="img/twitter.png" />
    </a>
    <a href="http://www.facebook.com/sharer.php?s=100
	&amp;p[url]=http://www.digly.jp/user.php?id=<25f3c6a6cf5b6ca74f2c3d492271275e />&amp;
	p[title]=digly.jp&amp;p[summary]=[userpage]<35d13e4d54ac0c7b749f53b78ea9e4ad />&amp;m2w" target="_blank" rel="nofollow">
    ...
    <a href="view.php?id=<?= $_REQUEST['id']; ?>">All</a>
    </span>
    <span>
    <a href="view_post.php?id=<?= $_REQUEST['id']; ?>">Post</a>
    </span>
    <span>
    <a href="view_like.php?id=<?= $_REQUEST['id']; ?>" style="color:#3498db;">Faborite</a>
    </span>
    </div>
    ...
    <?php
	   $js_music_post = $dbh->prepare("select preview from music_contents where id in (select like_contents_id from music_likes where like_user_id = :request) ORDER BY created DESC");
